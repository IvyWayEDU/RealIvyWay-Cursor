...
export default function AdminSupportClient() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex-1">
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent"
            />
          </div>
      ...
      <section className="rounded-xl bg-white shadow-sm ring-1 ring-gray-200 overflow-hidden">
        ...
        <div className="sm:hidden divide-y divide-gray-200">
          {isLoading ? (
            ...
            <div className="p-4 text-sm text-gray-500">No open tickets.</div>
          ) : (
            openTickets.map((t) => {
                ...
                <div key={t.id} className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="text-sm font-semibold text-gray-900 break-words">{t.subject}</div>
                      <div className="mt-1 text-xs text-gray-500 font-mono">{t.id.slice(0, 8)}…</div>
                    </div>
                  ...
                  <div className="mt-3 grid grid-cols-1 gap-1 text-sm text-gray-700">
                    <div className="break-words">
                      ...
                      <span className="font-medium text-gray-900">{t.user?.name || t.userId}</span>
                    </div>
                    {t.user?.email ? (
                      <div className="break-words">
                        <span className="text-gray-500">Email:</span>{' '}
                        <span className="font-medium text-gray-900">{t.user.email}</span>
                      </div>
                    ) : null}
                    <div>
                      <span className="text-gray-500">Created:</span>{' '}
                      <span className="font-medium text-gray-900">{formatTime(t.createdAt)}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Updated:</span>{' '}
                      <span className="font-medium text-gray-900">{formatTime(t.updatedAt || t.lastMessageAt)}</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center rounded-md bg-white px-3 py-2.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                    >
                      View Ticket
                    </button>
                  </div>
      ...
      <section className="rounded-xl bg-white shadow-sm ring-1 ring-gray-200 overflow-hidden">
        ...
        <div className="sm:hidden divide-y divide-gray-200">
          {isLoading ? (
            ...
            <div className="p-4 text-sm text-gray-500">No resolved tickets.</div>
          ) : (
                ...
                <div key={t.id} className="p-4">
                  ...
                  <div className="mt-3 grid grid-cols-1 gap-1 text-sm text-gray-700">
                    ...
                    <div>
                      ...
                      <span className="font-medium text-gray-900">{formatTime(t.resolvedAt || null) || '—'}</span>
                    </div>
                  </div>
      ...
      {/* Ticket detail modal */}
      {selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))]">
            ...
            <div className="px-5 py-4 border-b border-gray-200 flex items-start justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 shrink-0 w-full sm:w-auto">
                <button
                  ...
                  className="w-full sm:w-auto rounded-md bg-white px-3 py-2.5 sm:py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 disabled:opacity-50"
                >
                  Mark as Pending
                </button>
                <button
                  ...
                  disabled={isUpdatingStatus}
                  className="w-full sm:w-auto rounded-md bg-emerald-600 px-3 py-2.5 sm:py-2 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-50"
                >
                  Mark as Resolved
                </button>
                <button
                  ...
                  disabled={isUpdatingStatus}
                  className="w-full sm:w-auto rounded-md bg-white px-3 py-2.5 sm:py-2 text-sm font-semibold text-red-700 ring-1 ring-inset ring-red-300 hover:bg-red-50 disabled:opacity-50"
                >
                  Close Ticket
                </button>
                <button
                  ...
                  className="w-full sm:w-auto rounded-md bg-white px-3 py-2.5 sm:py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                >
                  Close
                </button>
              </div>
                ...
                <form onSubmit={sendReply} className="border-t border-gray-200 bg-white p-4">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="rounded-md bg-indigo-600 px-4 py-2.5 sm:py-2 text-sm font-semibold text-white hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
