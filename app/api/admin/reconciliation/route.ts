  ...
  try {
    ...
    if (exportKind === 'csv') {
      ...
      const rows: Array<Array<unknown>> = [
        ...
        ['total_student_refunds', money(t.totalStudentRefundsCents), t.totalStudentRefundsCents],
        ['total_student_net_payments', money(t.totalStudentNetPaymentsCents), t.totalStudentNetPaymentsCents],
        ...
        ['provider_credits_ledger', money(t.providerCreditsCents), t.providerCreditsCents],
        ['provider_adjustments', money(t.providerAdjustmentsCents), t.providerAdjustmentsCents],
        ...
        ['credits_mismatch', 'credits + adjustments - computed_earnings'],
        ['credits_mismatch_cents', money(data.balanceCheck.providerCreditsMinusComputedEarningsCents), data.balanceCheck.providerCreditsMinusComputedEarningsCents],
        [],
