    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* System Activity Section - Placeholder */}
          <div className="overflow-hidden rounded-lg bg-white shadow">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="rounded-md border border-gray-200 p-4 hover:bg-gray-50 cursor-not-allowed opacity-50">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-900">Approve Providers</p>
                  </div>
                </div>
              </div>
              <div className="rounded-md border border-gray-200 p-4 hover:bg-gray-50 cursor-not-allowed opacity-50">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-900">Review Courses</p>
                  </div>
                </div>
              </div>
              <div className="rounded-md border border-gray-200 p-4 hover:bg-gray-50 cursor-not-allowed opacity-50">
          ...
          <div className="overflow-hidden rounded-lg bg-white shadow">
            ...
            <div className="p-6">
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Items awaiting approval will appear here.
                </p>
              </div>
            </div>
          </div>
