  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-[100svh] items-center justify-center p-4 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))]">
        ...
        {/* Modal */}
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-5 sm:p-6">
          ...
          {isSubmitted ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  onClick={onClose}
                  className="w-full sm:flex-1 inline-flex items-center justify-center px-4 py-3 sm:py-2 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-50 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={!canSubmit}
                  className={`w-full sm:flex-1 inline-flex items-center justify-center px-4 py-3 sm:py-2 text-sm font-medium rounded-md transition-colors ${
                    canSubmit
