          ...
          <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-end gap-3">
              <button
                ...
                disabled={isWorking}
                className="w-full sm:w-auto inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-3 sm:py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
              >
                Close
              </button>
            </div>
