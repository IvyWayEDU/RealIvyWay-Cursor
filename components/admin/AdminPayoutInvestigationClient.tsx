                    ...
                    <div className="overflow-hidden rounded-lg border border-gray-200">
                      ...
                      <div className="sm:hidden divide-y divide-gray-200 bg-white">
                        {r.payoutRequests.map((p) => {
                          ...
                          return (
                            <div key={p.id} className={['px-4 py-4', busy ? 'opacity-70' : ''].join(' ')}>
                              <div className="flex items-start justify-between gap-4">
                                <div className="min-w-0">
                                  ...
                                  <div className="mt-2 text-xs text-gray-600 break-words">
                                    Destination: {p.payoutDestinationMasked || '—'}
                                  </div>
                                ...
                                <div className="shrink-0 text-right">
                                  <div className="text-sm font-semibold text-gray-900">{money(p.amountCents)}</div>
                                  <div className="mt-1">
