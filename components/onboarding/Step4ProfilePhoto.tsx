...
interface Step4ProfilePhotoProps {
  ...
  onUpdate: (profileImageUrl: string | null) => void;
  onSkip?: () => void;
}

export default function Step4ProfilePhoto({
  profileImageUrl,
  onUpdate,
  onSkip,
}: Step4ProfilePhotoProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Add a profile photo (optional)</h2>
        <p className="mt-2 text-sm text-gray-500">
          Providers with a profile photo are up to 90% more likely to get hired
        </p>
      </div>
