...
import { getDevPaidSessionsByProviderId } from '@/lib/devSessionStore';
  ...
  useEffect(() => {
    const fetchSessions = async () => {
      ...
      try {
        ...
        const upcomingSessions = getDevPaidSessionsByProviderId(userId);
                      ...
                      <div className="mb-2 flex items-center gap-1 text-sm">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-14 0h14z"
                          />
                        </svg>
