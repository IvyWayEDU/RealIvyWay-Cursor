...
exports.PRICING_CATALOG = void 0;
exports.formatUsdFromCents = formatUsdFromCents;
exports.getCatalogItemByKey = getCatalogItemByKey;
exports.getPricingKey = getPricingKey;
exports.getSessionPricingCents = getSessionPricingCents;
exports.getProviderPayoutCents = getProviderPayoutCents;
// NOTE: Use a relative import so `tsconfig.scripts.json` (used for scripts) can compile without Next.js path aliases.
const getProviderPayout_1 = require("../payouts/getProviderPayout");
/**
...
function getSessionPricingCents(args) {
    ...
    const provider_payout_cents = Math.max(0, Math.floor((0, getProviderPayout_1.getProviderPayout)(payoutServiceType) * 100));
...
function getProviderPayoutCents(service_type, duration_minutes, plan) {
    ...
    return Math.max(0, Math.floor((0, getProviderPayout_1.getProviderPayout)(payoutServiceType) * 100));
}
